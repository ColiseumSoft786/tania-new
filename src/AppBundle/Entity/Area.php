...
class Area
{
     ...
     * Many Areas have One Field.
     *
     * @ORM\ManyToOne(targetEntity="MainArea", inversedBy="areas")
     * @ORM\JoinColumn(name="mainarea_id", referencedColumnName="id")
     */
     private $mainarea;
     ...
     * Set MainArea
     *
     * @param \AppBundle\Entity\MainArea $mainarea
     *
     * @return Device
     */
    public function setMainArea(\AppBundle\Entity\MainArea $mainarea = null)
    {
     ...
     * Get Main Area
     *
     * @return \AppBundle\Entity\MainArea
     */
